...
* Tags of a person can be edited
...
== Editing tags of a person

Add/Revise/Remove tags of the specified person. +
Format: `revise INDEX [t/TAG]...`

****
Edit the person at the specified `INDEX`.
The index references the same as `VIEW`.
New tags can be of any number (including 0).
****
...
* `list` +
`revise 2 t/patient` +
Change the tag of the 2nd person in the address book to `[patient]`.
