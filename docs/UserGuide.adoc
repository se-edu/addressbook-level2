...
== Listing all persons in ascending alphabetical order : `sortedlist`

Shows an alphabetically sorted list of all persons, along with their non-private details, in the address book. +
Format: `list`
