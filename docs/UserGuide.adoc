...
== Finding all people starting with letter: `filter`

Finds all people starting with the letter specified. +
Format: `find LETTER`

[NOTE]
===
LETTER is case sensitive, and only allows for a single alphabet.
===

Examples:

* `filter A` +
Returns all persons starting with A.
