...
Deletes the specified people from the address book. Irreversible. +
Format: `deleteM INDEX, INDEX, INDEX`

****
Deletes the people at the specified `INDEX`.
The indexes refer to the index number shown in the most recent listing.
****
...
* `list` +
`deleteM 2,3` +
Deletes the 2nd person and 3rd person in the address book.
