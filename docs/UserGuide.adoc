...
== Sort the current list of people: `sort`

Sorts the current list of all people, according to a given property, and with a stated order (ascending vs descending)
Format: `sort` PROPERTY ORDER
