...
* https://se-edu.github.io/se-book/cppToJava/exceptions/[se-edu/se-book: cppToJava: Exceptions]
...
* https://se-edu.github.io/se-book/cppToJava/inheritance/[se-edu/se-book: cppToJava: Inheritance]
...
* https://se-edu.github.io/se-book/cppToJava/classes/classLevelMembers/[se-edu/se-book: cppToJava: Classes: Class-Level Members]
