...
* https://se-edu.github.io/se-book/oop/objects/encapsulation/[se-edu/se-book: Design: OOP: Objects: Encapsulation]
...
* https://se-edu.github.io/se-book/oop/classes/[se-edu/se-book: Design: OOP: Classes]
...
* https://se-edu.github.io/se-book/oop/inheritance/[se-edu/se-book: Design: OOP: Inheritance]
...
* https://se-edu.github.io/se-book/oop/classes/classLevelMembers/[se-edu/se-book: Design: OOP: Classes: Class-Level Members]
...
* https://se-edu.github.io/se-book/oop/associations/composition/[se-edu/se-book: Design: OOP: Associations: Composition]
...
* https://se-edu.github.io/se-book/oop/associations/associationClasses/[se-edu/se-book: Design: OOP: Associations: Association Classes]
