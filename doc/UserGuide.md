...
### Listing all persons in alphabetical order of their names : `sortedlist`
Shows a list of all persons in the address book, sorted in alphabetical order of their names.<br>
Format: `sortedlist`
