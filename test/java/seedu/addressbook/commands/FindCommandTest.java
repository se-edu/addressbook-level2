...
public class FindCommandTest extends CommandTest {
    ...
    public void execute_find_isCaseSensitive() throws IllegalValueException {
        ...
        assertCommandBehavior("find Claude",
                Command.getMessageForPersonListShownSummary(expectedOne),
                testMain.getAddressBook(),
                expectedOne);
        
        
        assertCommandBehavior("find cLaude",
                Command.getMessageForPersonListShownSummary(expectedZero),
                testMain.getAddressBook(),
                expectedZero);
    }
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws IllegalValueException {
        ...
        assertCommandBehavior("find Laude",
    ...
    public void execute_find_multipleMatches() throws IllegalValueException {
        ...
        assertCommandBehavior("find Claude Hopper",
                Command.getMessageForPersonListShownSummary(expectedList),
                testMain.getAddressBook(),
                expectedList);
    }
